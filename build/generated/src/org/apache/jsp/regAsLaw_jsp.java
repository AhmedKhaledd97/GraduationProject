...
public final class regAsLaw_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("         ");
             ...
             DB db = new DB();
             set = db.selecoLawCatagory();
             ss= db.selecoLawCatagory();
             msg = (String)request.getAttribute("msgLaw");
             if(msg != null){
    ...
    msg="";
      ...
      out.write("              <form class=\"form text-center\" name=\"myform\" onsubmit=\"return validateform()\" action=\"regAsLawServ\" method=\"POST\" enctype=\"multipart/form-data\">\n");
